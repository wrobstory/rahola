...
The benchmark is the simplest ship that can capsize: a one-degree-of-freedom nonlinear roll
model, validated against analytic limits, generating seeded trajectories under JONSWAP forcing
(Hasselmann et al. 1973). Three restoring
