...
\begin{itemize}\setlength{\itemsep}{1pt}\item Five motion-only capsize scores were compared with frozen thresholds.\item Window AUC stayed 0.883 to 0.913 across tested forcing bandwidths.\item Tested scores were near chance inside an established severe regime.\item No 10-s emission opportunity preceded 92 percent of heralded capsizes.\item In one six-shape library, wave-group descriptors gave AUC 0.934.\end{itemize}
...
(Santiago Caama\~no et al. 2025), and the field's general
...
second-generation intact stability criteria (Ba\v{c}kalov et al. 2016; IMO 2020, 2022; Petacco and
...
(\texttt{results/validation\_acceptance.json}) alongside their thresholds.
...
\begin{table}[H]\footnotesize\caption{The experiment ledger. Every experiment's primary question, the data it was evaluated on, how its operating choices were selected, what its intervals mean, and its verdict. Confirmatory preregistered gates are distinguished from descriptive diagnostics; the D4 row is descriptive on both counts.}\begin{tabular}{>{\raggedright\arraybackslash}p{0.153\linewidth}>{\raggedright\arraybackslash}p{0.153\linewidth}>{\raggedright\arraybackslash}p{0.153\linewidth}>{\raggedright\arraybackslash}p{0.153\linewidth}>{\raggedright\arraybackslash}p{0.153\linewidth}>{\raggedright\arraybackslash}p{0.153\linewidth}}\hline
\textbf{Experiment} & \textbf{Primary question} & \textbf{Data access} & \textbf{Selection rule} & \textbf{Intervals} & \textbf{Verdict} \\\hline
...
\textbf{Ranking under changing forcing bandwidth (D3).} Classical critical-slowing-down indicators
...
\textbf{Operating points at frozen thresholds (D1).} Ranking skill is not an alarm. Here each
...
\textbf{Threshold transfer across failure modes (D2).} A deployed system cannot know which failure
...
\textbf{Timing inside the severe regime (D5).} The two clocks of the Introduction are separated by
...
\textbf{The character of false alarms (D4).} What is a false alarm made of? Because the seaway is
...
\textbf{Reference comparators.} To locate the learned methods, three references were scored on a
...
\textbf{Operating the split-time decomposition onboard (U1, H1).} The split-time method writes the
...
from the roll period (Terada et al. 2016; M\'iguez Gonz\'alez et al. 2017; full-scale voyage
...
\hangindent=1.5em\hangafter=1\noindent Higo, Y., Chikamori, R., Hashimoto, H., Yamamoto, Y., Masutani, Y., and Matsuda, A. (2025). Estimation of the natural roll period of a large containership from ship motion observed during voyages. \emph{Proceedings of the 20th International Ship Stability Workshop}, Chania, 139--147.\par
\hangindent=1.5em\hangafter=1\noindent IMO (2010). \emph{Adoption of Performance Standards for Bridge Alert Management}. Resolution MSC.302(87), International Maritime Organization, London.\par
...
\hangindent=1.5em\hangafter=1\noindent IMO (2022). \emph{Explanatory Notes to the Interim Guidelines on the Second Generation Intact Stability Criteria}. MSC.1/Circ.1652, International Maritime Organization, London.\par
\hangindent=1.5em\hangafter=1\noindent Joo, H., Song, B., Park, K., Kwon, K., and Im, T. (2026). Uncertainty-aware short-horizon warning of large-inclination exceedance in small fishing vessels: a simulation-based multi-model benchmark. \emph{Journal of Marine Science and Engineering} 14(13), 1195.\par
...
\hangindent=1.5em\hangafter=1\noindent Lopac, N., Severinski, K., Palai\'c, D., and Lerga, J. (2026). Machine learning for ship-motion-based sea-state estimation. \emph{Ocean Engineering} 362, 126362.\par
\hangindent=1.5em\hangafter=1\noindent Louvros, P., Stefanou, E., Htein, N. M., Boulougouris, E., and Vassalos, D. (2025). Uncertainty-aware decision support for real-time damage stability assessment in maritime emergencies. \emph{Proceedings of the 20th International Ship Stability Workshop}, Chania, 269--277.\par
\hangindent=1.5em\hangafter=1\noindent Mak, B., Scholcz, T. P., and van 't Veer, R. (2025). Development of an onboard machine learning based early warning system for dynamic ship stability loss after damage. \emph{Proceedings of the 20th International Ship Stability Workshop}, Chania, 263--268.\par
...
\hangindent=1.5em\hangafter=1\noindent Radhakrishnan, R., Pavithran, I., Livina, V., Kurths, J., and Sujith, R. I. (2025). Early warnings are too late when parameters change rapidly. \emph{Scientific Reports} 15, 20256.\par
...
\hangindent=1.5em\hangafter=1\noindent Rice, S. O. (1945). Mathematical analysis of random noise. \emph{Bell System Technical Journal} 24(1), 46--156.\par
...
\hangindent=1.5em\hangafter=1\noindent Santiago Caama\~no, L., D\'iaz Gonz\'alez, I., and M\'iguez Gonz\'alez, M. (2025). Application of a stability monitoring system to naval vessels. \emph{Proceedings of the 20th International Ship Stability Workshop}, Chania, 149--156.\par
...
\hangindent=1.5em\hangafter=1\noindent Takami, T., Nielsen, U. D., Mounet, R. E. G., and Sasa, K. (2026). A data-driven scheme for updating of parameters for ship roll motion. \emph{Ocean Engineering} 356, Part 2, 125346.\par
...
\hangindent=1.5em\hangafter=1\noindent Umeda, N., Maruyama, Y., Belenky, V., and Weems, K. (2025). Discussion to self-repeating effect in reconstruction of irregular waves for direct stability assessment. \emph{Proceedings of the 20th International Ship Stability Workshop}, Chania, 215--225.\par
...
\hangindent=1.5em\hangafter=1\noindent Zhang, Y., Huang, L., Jiang, F., Duan, W., Tang, L., and Ni, T. (2026). Real-time estimation of wave elevation and statistics from ship motions based on machine learning. \emph{Ocean Engineering} 349, 124144.\par
