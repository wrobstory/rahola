...
\begin{center}{\LARGE\bfseries Motion-Only Capsize Warning on an Audited Synthetic Benchmark: Observable Vulnerability, Encounter-Decided Timing}\end{center}
